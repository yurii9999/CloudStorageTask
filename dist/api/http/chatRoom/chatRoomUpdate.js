...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const chatRoom = yield chatRoomService_1.default.update(req.currentUser.id, req.params.id, req.body);
        yield apiResponseHandler_1.default.success(req, res, chatRoom);
    }
    catch (error) {
        yield apiResponseHandler_1.default.error(req, res, error);
    }
});
//# sourceMappingURL=chatRoomUpdate.js.map